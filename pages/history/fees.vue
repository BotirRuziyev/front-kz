<template>
  <div class="history-page system-fees__history">
    <div v-if="!search">
      <block-nav-bar
        to="/history"
        :text="pageTitle"
      ...
      <div class="history-content">
        ...
        <transfer-history-item
          ...
          :data="historyData"
          color="color-green"
          @openModal="isNetworkFee = true"
        />
        <transfer-history-item
          v-if="expensis && !deposit"
          :data="expensisData"
          color="color-brown"
          @openModal="isCompensation = true"
        />
      </div>
    </div>
    ...
    <history-modal
      ...
      :is-visible="isNetworkFee"
      @close="isNetworkFee = false"
    >
      <div class="modal-head">
        <button class="close-btn" @click="isNetworkFee = false">
          <CloseIcon />
        </button>
        <div class="coin-icon">
          <img :src="require('@/assets/svg/litecoin-ltc.svg')" alt="" />
        </div>
        <h3 class="modal-title">Details of Network Fee</h3>
      ...
      <div class="user-info">
        <ul class="user-info__list">
          ...
          <li class="list-item">
            <div class="info-head">
              <h5 class="info-top__text">Transaction ID</h5>
              <h5 class="info-top__text">Status</h5>
            </div>
            <div class="info-bottom">
              <h5 class="info-bottom__text">#NF-20394</h5>
              <h5 class="info-bottom__text">Completed</h5>
            </div>
          </li>
          <li class="list-item">
            <div class="info-head">
              <h5 class="info-top__text">Fee Type</h5>
            </div>
            <div class="info-bottom">
              <h5 class="info-bottom__text">Blockchain Transaction Fee</h5>
            </div>
          </li>
          <li class="list-item">
            <div class="info-head">
            ...
            <div class="info-bottom">
              <h5 class="info-bottom__text">Bitcoin</h5>
            </div>
          </li>
          <li class="list-item">
            <div class="info-head">
            ...
            <div class="info-bottom">
              <h5 class="info-bottom__text">Processed through Oracle System</h5>
            </div>
          </li>
          <li class="list-item">
            <div class="info-head">
              <h5 class="info-top__text">Amount</h5>
            </div>
            <div class="info-bottom">
              <h5 class="info-bottom__text total-bottom__text">
                0.0005 BTC <span>≈ $10.98</span>
              </h5>
            </div>
          </li>
        </ul>
      </div>
      <Nuxt-link to="#" class="more-btn">View More Details</Nuxt-link>
    </history-modal>
    <history-modal
      class="history-successfully__modal"
      :is-visible="isCompensation"
      @close="isCompensation = false"
    >
      <div class="modal-head">
        <button class="close-btn" @click="isCompensation = false">
          <CloseIcon />
        </button>
        <div class="coin-icon">
          <img :src="require('@/assets/svg/litecoin-ltc.svg')" alt="" />
        </div>
        <h3 class="modal-title">Details of Compensation</h3>
        <div class="border-bottom">
          <svg
            width="290"
            height="1"
...
export default class FeesHistoryPage extends Vue {
  searchIcon = true
  search = false
  allCheck = false
  step = 0
  ...
  pageTitle = 'History'
  expensisTitle = 'System Fees'
  depositTitle = 'System Fees'
  expensis = false
  deposit = true
  isOpen = false
  filterModal = false
